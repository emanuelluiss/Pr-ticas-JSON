...
let calcularTempo = (alturaMenor, taxaMenor, alturaMaior, taxaMaior) => {
    let quantidadeDeAnos = 0
...
console.log(calcularCrescimento(120, 3, 150, 2))
console.log(calcularCrescimento(110, 2, 130, 3))